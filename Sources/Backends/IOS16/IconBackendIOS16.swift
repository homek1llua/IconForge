...
final class IconBackendIOS16: IconBackend, @unchecked Sendable {
    ...
    let name = "iOS 16 Privileged Bundle Replace + Cache"
    ...
    private func clearRelatedCache(for app: InstalledApp) {
        let cacheDirs = [
        ...
        for cacheDir in cacheDirs {
            filesystem.removeItemPrivileged(at: cacheDir)
        }
    }
}
